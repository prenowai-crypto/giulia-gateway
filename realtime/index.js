// ═══════════════════════════════════════════════════════════════════════════════
// PRENOW - REALTIME GATEWAY v1.6.0
// FIX: Echo removed (inbound_track only), turn detection tuned
// ═══════════════════════════════════════════════════════════════════════════════
...
app.post('/twiml-stream', (req, res) => {
  ...
  // TeXML: inbound_track riceve solo audio utente, bidirectional permette di inviare
